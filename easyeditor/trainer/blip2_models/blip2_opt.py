...
class Blip2OPT(Blip2Base):
    ...
    def __init__(
        ...
        freeze_qformer=True,
        num_query_token=32,
        opt_model="hugging_cache/opt-2.7b",
        prompt="",
        max_txt_len=2048,
        ...
        self.opt_tokenizer = AutoTokenizer.from_pretrained(opt_model, use_fast=False, cache_dir="./hugging_cache")
        self.opt_model = OPTForCausalLM.from_pretrained(
            opt_model, torch_dtype=torch.float16, cache_dir="./hugging_cache"
        )
